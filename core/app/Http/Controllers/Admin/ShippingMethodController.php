...
class ShippingMethodController extends Controller
{
    ...
    {
        $page_title         = 'Delivery Method Manager';
    ...
    {
        $page_title = 'Create New Delivery Method';
    ...
    {
        $shipping_method =  $id;
        $page_title = 'Edit Delivery Method';
    ...
    public function store(Request $request, $id)
    {
        ...
        if($id ==0){
            ...
            $notify[] = ['success', 'Delivery Method Created Successfully'];
        }else{
            $sm = ShippingMethod::findOrFail($id);
            $notify[] = ['success', 'Delivery Method Updated Successfully'];
        }
    ...
    {
        $id->delete();
        $notify[] = ['success', 'Delivery Method Deleted Successfully'];
        return redirect()->back()->withNotify($notify);
    }
